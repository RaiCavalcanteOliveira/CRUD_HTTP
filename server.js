...
const router = jsonServer.router('cadastro.json');
...
// app.get('/', function(req, res) {
//     res.sendFile(__dirname + '/public/bemvindo.html');
// })

// app.get('/', function(req, res) {
//     res.sendFile(__dirname + '/public/deletamsg.html');
// })
...
// app.get('/', function(req, res) {
//     res.sendFile(__dirname + '/public/paginadofuncionario.html');
// })

// app.get('/', function(req, res) {
//     res.sendFile(__dirname + '/public/resgatardados.html');
// })
